// The ONE shared classifier (hooks/irreversible-gate.mjs) so the CLI and the
// plugin hook never drift. The .mjs ships without types of its own; since a
// relative import to an existing file resolves to that file (and so ignores any
